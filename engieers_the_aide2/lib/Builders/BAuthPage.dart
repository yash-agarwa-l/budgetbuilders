...
import 'package:engieers_the_aide/Services/userAuthFunction.dart';
...
class BAuthPage extends StatefulWidget {
  const BAuthPage({super.key});

  @override
  State<BAuthPage> createState() => _authPageState();
}

class _authPageState extends State<BAuthPage> {

  final _orderBox = Hive.box('myOrders');

  void add(bName) {
    _orderBox.put("BName", bName);
  }
